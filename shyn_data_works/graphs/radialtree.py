...
def plot_radial_tree(Z2,fontsize=8,figsize=None, pallete="gist_rainbow", addlabels=True, show=True,sample_classes=None,colorlabels=None,
    ...
    if colorlabels != None:
        ...
        for labelname, colorlist in colorlabels.items():
            ...
            circle = plt.Circle((0,0),innerrad, fc='whitesmoke') # type: ignore
        ...
        for labelname, colorlist in sample_classes.items():
            ...
            ## ! review later 
            ucolors=sorted(list(np.unique(colorlist))) # type: ignore 
